...
import "android.os.Build" -- Nécessaire pour détecter la version Android

-- ================= GAMELOOP FIX (WINDOW TYPE) =================
local OVERLAY_TYPE
if Build.VERSION.SDK_INT >= 26 then
    OVERLAY_TYPE = 2038 -- Android 8+ (Oreo et plus)
else
    OVERLAY_TYPE = 2002 -- Android 7 et moins (GameLoop classique)
end

-- Si ça plante encore, décommente la ligne ci-dessous pour forcer le vieux mode:
-- OVERLAY_TYPE = 2002 
...
local t = TextView(activity); t.setText("GAMELOOP V13"); t.setTextColor(Color.MAGENTA); t.setTextSize(14); t.setGravity(17)
content.addView(t)
...
local btnClose = Button(activity); btnClose.setText("Fermer"); btnClose.setTextSize(12); btnClose.setTextColor(Color.RED); btnClose.setHeight(80)
...
print("✅ GAMELOOP FIX CHARGÉ (Window Type: "..OVERLAY_TYPE..")")
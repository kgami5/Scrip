...
scanLoop = Runnable({ run = function()
    ...
    if img then
      ...
      if count > 0 then
        ...
        -- 2. DESSINER LA LIGNE (STYLE DRONE / ORBITAL)
        -- Départ : SW / 2 (Milieu écran en largeur), 0 (Tout en haut)
        -- Arrivée : La cible
        hudCanvas.drawLine(SW / 2, 0, targetX, targetY, hudPaint)
